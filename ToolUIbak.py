...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        icon.addPixmap(QtGui.QPixmap(
            "White/e52d9567c015cdb440344305380739e7.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1.addPixmap(QtGui.QPixmap(
            "White/b721a1c9956b6e836cbdb6c57691ef09.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("White/ooopic_1494068712.png"),
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate(
            "MainWindow", "<html><head/><body><p>1、程序运行可以获取天猫或京东商品的DSR信息并生成数据表格</p><p>2、在程序所在目录创建一个文本文件，在其中放入商品ID，每行放一个</p><p>3、在文件名称输入框中输入放有商品ID的文件名称或直接使用默认文件名称</p><p>4、选择商品类型，启动开始按钮，等待程序运行结束后获取信息表格</p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_1), _translate("MainWindow", "商品DSR提取"))
        ...
        self.label_2.setText(_translate(
            "MainWindow", "<html><head/><body><p>1、程序运行可以获取天猫商品的主图链接和价格（原价&amp;折扣价）</p><p>2、在程序所在目录创建一个文本文件，在其中放入商品ID，每行放一个</p><p>3、在文件名称输入框中输入放有商品ID的文件名称或直接使用默认文件名称</p><p>4、上述步骤完成后按下开始按钮，等待程序运行结束后获取信息表格</p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_2), _translate("MainWindow", "天猫主图提取"))
        ...
        self.label_3.setText(_translate(
            "MainWindow", "<html><head/><body><p>1、程序运行可以按照所给图片链接下载图片并按要求给图片命名</p><p>2、在程序所在目录创建一个文本，在其中放入图片链接和名称，每行放一个</p><p>3、文件中格式如：1234,https://www.img.jpg，即名称和链接用英文逗号连接</p><p>4、输入包含链接的文件名称和图片保存文件夹名称，按开始按钮开始下载图片</p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_3), _translate("MainWindow", "图片批量下载"))
